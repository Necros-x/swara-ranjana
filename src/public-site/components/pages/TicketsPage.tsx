      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl mb-16 sm:mb-20">
          ...
          <p className="text-base sm:text-lg text-[#31465A] font-light leading-relaxed font-serif mb-8">
            Choose the experience that suits you, then use the auditorium map to understand the exact block and row geometry before reserving.
          </p>
        ...
        <section
          id="auditorium-geometry"
          className="p-5 sm:p-8 lg:p-12 border border-ink-10 bg-[#F9FBFC] rounded-sm mb-20 scroll-mt-28"
        >
          <SectionLabel label="Auditorium Geometry" number="02" className="mb-4" />
          <EditorialHeading size="md" className="mb-3">
            Hall Seating Map
          </EditorialHeading>
          <p className="mb-8 max-w-3xl text-xs sm:text-sm leading-relaxed text-[#7D8A95]">
            A row-accurate digital reconstruction of the supplied auditorium seating plan. Tap a block to inspect its exact row count and capacity.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-ink-10 text-xs text-[#31465A] font-light">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              For corporate reservations of 6+ guests or private reception arrangements, contact concierge@swararanjana.lk.
            </p>
          </div>
          <div>
            <h4 className="font-medium text-[#0E1721] text-sm mb-2">Accessibility Seating</h4>
            <p className="leading-relaxed">
              For wheelchair access, companion spaces, or another seating requirement, contact Swara Ranjana before completing the reservation.
            </p>
          </div>
        </div>
      </div>
