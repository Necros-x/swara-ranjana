...
export default async function AccountLoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#F7F9FA] px-4 py-12 text-[#0E1721]">
      <img
        src="/butterfly/RTop.webp"
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute -right-28 -top-24 w-[520px] opacity-[.07]"
      />
